...
function install_neovim {
    ...
    "${DISTRO_FOLDER}/install_neovim.sh"
}
...
function install_pyenv {
	...
	if yes_or_none "Install Python build dependencies?" ; then
		sudo dnf install -y make build-essential libssl-dev \
...
function install_others {
    ...
    # install_distro_specific should be sourced from distro_specific install_other.sh script
    yes_or_none "Install ${DISTRO_LIKE} specific apps?" && install_distro_specific
}
